...
function RecruitmentPage() {
  ...
  if (isLoadingPostings || isLoadingApplicants) return <DashboardPending />;
  if (isErrorPostings) return <div>Error loading recruitment data.</div>;
  ...
  const filteredApplicants = applicants.filter((a) => {
    ...
    const email = a.email || "";
    const refCode = a.referenceCode || "";
    const fullSearch =
      `${firstName} ${lastName} ${email} ${refCode}`.toLowerCase();
        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="flex flex-col xl:flex-row gap-6 items-start">
            ...
            <div className="flex-1 min-w-0 space-y-6">
              ...
              {/* ── Tabs: clearly above their content ── */}
                                          ...
                                          <AlertDialog>
                                            ...
                                            <AlertDialogContent>
                                              <AlertDialogHeader>
                                                ...
                                                <AlertDialogDescription>
                                                  This will archive the posting
                                                  and notify pending candidates.
                                                </AlertDialogDescription>
                                              </AlertDialogHeader>
                                              <AlertDialogFooter>
                                                <AlertDialogCancel>
                              ...
                              <TableRow>
                                ...
                                >
                                  <div className="flex flex-col items-center justify-center gap-3">
                                    <div className="h-14 w-14 rounded-2xl bg-muted/5 border border-dashed border-border/20 flex items-center justify-center">
                                      <HugeiconsIcon
                                    ...
                                    {!(
                                      ...
                                      <Button
                                        variant="outline"
                                        size="sm"
                                        className="mt-2 h-8 text-[10px] font-black uppercase tracking-widest rounded-xl"
                              ...
                              >
                                <TableCell className="pl-6 py-4">
                                  <div className="flex items-center gap-3">
                                    ...
                                    />
                                    <div>
                                      <p className="text-sm font-bold text-foreground/85 leading-tight">
                                        {a.firstName} {a.lastName}
                                      </p>
                                      <p className="text-[9px] font-medium text-muted-foreground/40 uppercase tracking-widest mt-0.5">
                                        {a.email}
                                      </p>
                                    </div>
                                  </div>
                                ...
                                <TableCell className="px-4">
                                  <span className="text-xs font-black tabular-nums text-foreground/70">
                                    {(a.score || 0).toFixed(1)}
                                  </span>
                                </TableCell>
                                <TableCell className="text-right pr-6">
              ...
              <Frame>
                <FramePanel className="bg-card border-border/30 p-0 overflow-hidden">
                  ...
                  <div className="p-4 border-t border-border/5">
                    <Button
                      variant="outline"
                      className="w-full text-[10px] font-black uppercase tracking-widest h-9 rounded-xl border-border/30"
                    >
                      View Talent Pool
                    </Button>
                  </div>
